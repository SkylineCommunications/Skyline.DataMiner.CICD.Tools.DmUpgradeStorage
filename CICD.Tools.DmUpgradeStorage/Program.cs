namespace Skyline.DataMiner.CICD.Tools.DmUpgradeStorage
{
    ...
    /// <summary>
    /// This .NET tool allows you to manage .dmupgrade packages in storage.
    /// </summary>
                ...
                host.ConfigureServices(services =>
                    {
                        services.AddLogging(loggingBuilder =>
                                ...
                                .AddSingleton<IDmUpgradeStorageService, DmUpgradeStorageService>();
                    })
